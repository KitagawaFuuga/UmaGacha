...
class _runGatya extends State<runGatya> {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    'ガチャ詳細',
                    style:
                        TextStyle(fontSize: Widht / 48.75, color: Colors.brown),
                  ),
                ),
              ),
              SizedBox(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Container(
                                      margin:
                                          EdgeInsets.only(right: Widht / 39),
                                      child: const Text(
                                        "50",
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Dialogcome2(_videoPlayerController!);
                    },
                    style: ElevatedButton.styleFrom(
                      primary: Colors.green.shade400, //ボタンの背景色
                    ),
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => SingleGatya()),
                    );
                  },
                  child: Container(
                    alignment: Alignment.bottomCenter,
  ...
  Future<void> Dialogcome2(VideoPlayerController controller) async {
    var Width = 390;
    return showDialog(
      context: context,
      builder: (BuildContext context) {
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Rungatya(movie: controller)));
                  },
                  child: Container(
                    alignment: Alignment.bottomCenter,
                    child: Text(
